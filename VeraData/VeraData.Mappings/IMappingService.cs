...
namespace VeraData.Mappings
{
    public interface IMappingService
    {
        ...
        SourceFile[] SourceFiles(SourceFileType[] entities);
    ...
    public class MappingService : IMappingService
    {
        ...
        public SourceFile[] SourceFiles(SourceFileType[] entities) => entities.Select(x => _mapper.Map<SourceFile>(x)).ToArray();
